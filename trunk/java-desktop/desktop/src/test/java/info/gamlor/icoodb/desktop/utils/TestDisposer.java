...
public class TestDisposer {
    ...
    @Test
    public void expectBindingGroupAsDisposable() {
        final Modifiable<Boolean> wasCalled = Modifiable.create(false);
        ...
        Disposable disp = Disposer.asDisposable(group);
        disp.dispose();
        Assert.assertTrue(wasCalled.getValue());
    }
}
