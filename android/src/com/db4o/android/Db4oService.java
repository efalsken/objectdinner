...
public class Db4oService extends Service implements ServerSetup {
    ...
    private void showNotification() {
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(this, 0,
                new Intent(this, Db4oClient.class), 0);
        // Set the info for the views that show in the notification panel.
        notification.setLatestEventInfo(this, "db4o Service",
                       text, contentIntent);
    ...
    public void runServer()  {
    	//new java.io.File(fullPath(this)).delete();
	    db4oServer = Db4oClientServer.openServer(
			  Db4oClientServer.newServerConfiguration(), fullPath(this), PORT);
	    db4oServer.grantAccess(USER, PASS);
	    Toast.makeText(this, "Server opened", Toast.LENGTH_SHORT).show();
    }
    ...
    private String fullPath(Context ctx) {
    	return ctx.getDir("data", 0) + "/" + FILE;
    }
}
